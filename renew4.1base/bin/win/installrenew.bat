...
echo SET _BASEDIR=%_BASEDIR%>> renewexport.bat
...
type setupfiles\setup2-1.src >> renewexport.bat
...
cd ..\..\
echo CALL "%%_BASEDIR%%\bin\win\_rcphelp.bat" "%%_BASEDIR%%\de.renew.loader.jar" >> bin\win\setupfiles\setup2-2.tmp
cd plugins
for %%F in (*.jar) do echo CALL "%%_BASEDIR%%\bin\win\_rcphelp.bat" "%%_BASEDIR%%\plugins\%%F" >> ..\bin\win\setupfiles\setup2-2.tmp
cd ..
cd libs
for %%F in (*.jar) do echo CALL "%%_BASEDIR%%\bin\win\_rcphelp.bat" "%%_BASEDIR%%\libs\%%F" >> ..\bin\win\setupfiles\setup2-2.tmp
cd ..
cd bin\win
...
type setupfiles\setup2-2.tmp >> renewexport.bat
del setupfiles\setup2-2.tmp
cd ..\..
cd libs
for %%F in (commons-cli*.jar) do echo CALL "%%_BASEDIR%%\bin\win\_rcphelp.bat" "%%_BASEDIR%%\libs\%%F" >> ..\bin\win\renewexport.bat
for %%F in (freehep*.jar) do echo CALL "%%_BASEDIR%%\bin\win\_rcphelp.bat" "%%_BASEDIR%%\libs\%%F" >> ..\bin\win\renewexport.bat
cd ..
cd bin\win
...
type setupfiles\setup2-3.src >> renewexport.bat
...
type setupfiles\setup3-6.src >> renewexport.bat
